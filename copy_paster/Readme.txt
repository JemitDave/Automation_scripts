...
Steps==>
	...
	2. Enter the desired doc name,
	   if document exist:
	   (a)enter new name; (b)press ik to append the existing text	
	3. To take a screenshot:
	   ...
	   (d)A time interval of 2 seconds is provided between the release of mouse bitton and deselection of 	              highlighted text/image
	4.To copy text:
	   (a)Copy the text as you normally would and the text will get pasted in the .txt file while adding an
	      empty line after everty copy.
